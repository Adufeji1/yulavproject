  ...
  return (
    ...
    >
      ...
      >
        ...
        <br />
        <br />
        <div className="1500px:w-[55%] 1100px:w-[78%] max-[1000px]:text-center max-[1000px]:content-center	 max-[1000px]:flex-wrap  w-[90%] flex flex-col ">
      ...
      <div
        id="2"
        className=" hidden 1000px:w-[40%] 1000px:flex content-right items-center justify-end place-content-center	"
      >
        {/* Hero Image */}
        <Image
