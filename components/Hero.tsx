...
const Hero: FC<Props> = () => {
  return (
    <div id="0" className="  justify-center  mx-auto my-5  w-full  flex flex-row relative items-center">
        <div id="1" className="1000px:w-[50%] flex flex-col 1000px:mt-[0px] text-center 1000px:text-left  mt-[150px]">
          ...
          <h2 className="dark:text-white text-black text-[30px]  w-full 1000px:text-[70px] font-[600] font-Josefin py-2 1000px:leading-[75px] 1500px:w-[50%]">
            Different <span className="text-[#3c75d0]">solutions</span> to distinguish your <span className="text-[#3c75d0]">brand.</span>
          </h2>
          <br />
          <br />
          <p className="dark:text-[#edfff4] text-[#000000ac] font-[600] text-[18] 1500px:!w-[55%] 1100px:!w-[70%]">
